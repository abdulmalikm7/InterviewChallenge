                ...
                child:ListView.builder(
                  ...
                  itemBuilder: (context,index){
                    return CategoryTile(
                      ...
                      categoeryName:categories[index].categoeryName ,
                    );
                  }) ,
              ),
              Container(
...
class CategoryTile extends StatelessWidget {
 ...
 final String imageUrl,categoeryName;
 CategoryTile({required this.imageUrl,required this.categoeryName});
  @override
  Widget build(BuildContext context) {
      ...
      onTap: () {
       Navigator.push(context,MaterialPageRoute(
        builder: (context)=> CategoryNews(
          category: categoeryName.toString().toLowerCase(),
          )
        )); 
      },
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(categoeryName,style: TextStyle(
                color: Colors.white,
                 fontSize: 14,
